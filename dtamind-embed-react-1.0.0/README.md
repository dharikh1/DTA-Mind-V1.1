...
Javascript library to display dtamind chatbot on your website

![Dtamind](https://github.com/DtamindAI/DtamindChatEmbed/blob/main/images/ChatEmbed.gif?raw=true)
...
A development server will be running on http://localhost:5678 automatically. Update `public/index.html` to connect directly to Dtamind:
...
<script type="module">
  ...
  Chatbot.init({
    chatflowid: '91e9c803-5169-4db9-8207-3c0915d71c5f', // Add your Dtamind chatflowid
    apiHost: 'https://your-dtamind-instance.com', // Add your Dtamind apiHost
  });
</script>
```
...
```html
<script type="module">
  import Chatbot from 'https://cdn.jsdelivr.net/npm/dtamind-embed-react/dist/web.js';
  Chatbot.init({
...
<dtamind-fullchatbot></dtamind-fullchatbot>
```
...
<script type="module">
  ...
  Chatbot.init({
    ...
    theme: {
      ...
      disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://dtamindai.com/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
      ...
      chatWindow: {
        ...
        footer: {
          ...
          text: 'Powered by',
          company: 'Dtamind',
          companyLink: 'https://dtamindai.com',
        },
      },
    },
  });
...
The Dtamind Embed React Proxy Server enhances the security of your chatbot implementation by acting as a protective intermediary layer. This server eliminates the need to expose sensitive Dtamind instance details in your frontend code and provides several key security benefits:

![Proxy Server](https://github.com/DtamindAI/DtamindChatEmbed/blob/main/images/proxyserver.png?raw=true)

- **Enhanced Security**: Conceals your Dtamind API host and chatflow IDs from client-side exposure
- **Access Control**: Implements strict domain-based restrictions for chatbot embedding
- **Secure Communication**: Acts as a secure gateway for all interactions between your website and Dtamind instance
...
API_HOST=https://your-dtamind-instance.com
dtamind_API_KEY=your-api-key
...
# chatflowId: The UUID of your Dtamind chatflow
...
4. Once the proxy server is running in production, you will be able to embed your chatbots safely without exposing your Dtamind API host and chatflow IDs as below:
...
Source code in this repository is made available under the [MIT License](https://github.com/DtamindAI/Dtamind/blob/master/LICENSE.md).
