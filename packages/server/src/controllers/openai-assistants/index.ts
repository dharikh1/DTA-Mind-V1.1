...
import { streamStorageFile } from 'dtamind-components'
...
const getFileFromAssistant = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (!fileStream) throw new InternalDtamindError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: getFileFromAssistant`)
