...
const createAssistant = async (requestBody: any, orgId: string): Promise<Assistant> => {
    try {
        ...
        if (!requestBody.details) {
            throw new InternalDtamindError(StatusCodes.INTERNAL_SERVER_ERROR, `Invalid request body`)
        }
        ...
        try {
            ...
            if (!credential) {
                throw new InternalDtamindError(StatusCodes.NOT_FOUND, `Credential ${requestBody.credential} not found`)
            }
            ...
            if (!openAIApiKey) {
                throw new InternalDtamindError(StatusCodes.NOT_FOUND, `OpenAI ApiKey not found`)
            }
            ...
            throw new InternalDtamindError(StatusCodes.INTERNAL_SERVER_ERROR, `Error creating new assistant - ${getErrorMessage(error)}`)
        }
        const newAssistant = new Assistant()
        Object.assign(newAssistant, requestBody)
...
const deleteAssistant = async (assistantId: string, isDeleteBoth: any): Promise<DeleteResult> => {
    try {
        ...
        if (!assistant) {
            throw new InternalDtamindError(StatusCodes.NOT_FOUND, `Assistant ${assistantId} not found`)
        }
        ...
        try {
            ...
            if (!credential) {
                throw new InternalDtamindError(StatusCodes.NOT_FOUND, `Credential ${assistant.credential} not found`)
            }
            ...
            throw new InternalDtamindError(StatusCodes.INTERNAL_SERVER_ERROR, `Error deleting assistant - ${getErrorMessage(error)}`)
        }
    } catch (error) {
        throw new InternalDtamindError(
            StatusCodes.INTERNAL_SERVER_ERROR,
...
const updateAssistant = async (assistantId: string, requestBody: any): Promise<Assistant> => {
    try {
        ...
        try {
            ...
            if (!credential) {
                throw new InternalDtamindError(StatusCodes.NOT_FOUND, `Credential ${body.credential} not found`)
            }
            ...
            throw new InternalDtamindError(StatusCodes.INTERNAL_SERVER_ERROR, `Error updating assistant - ${getErrorMessage(error)}`)
        }
    } catch (error) {
        throw new InternalDtamindError(
            StatusCodes.INTERNAL_SERVER_ERROR,
...
const getTools = async (): Promise<any> => {
    try {
        ...
        throw new InternalDtamindError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: assistantsService.getTools - ${getErrorMessage(error)}`)
    }
}
