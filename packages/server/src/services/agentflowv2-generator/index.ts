...
import { generateAgentflowv2 as generateAgentflowv2_json } from 'dtamind-components'
import { z } from 'zod'
...
const generateAgentflowv2 = async (question: string, selectedChatModel: Record<string, any>) => {
    try {
        ...
        throw new InternalDtamindError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: generateAgentflowv2 - ${getErrorMessage(error)}`)
    }
}
