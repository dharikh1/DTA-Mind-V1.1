...
export class RoleService {
    ...
    public validateRoleId(id: string | undefined) {
        if (isInvalidUUID(id)) throw new InternalDtamindError(StatusCodes.BAD_REQUEST, RoleErrorMessage.INVALID_ROLE_ID)
    }
    ...
    public validateRoleName(name: string | undefined) {
        if (isInvalidName(name)) throw new InternalDtamindError(StatusCodes.BAD_REQUEST, RoleErrorMessage.INVALID_ROLE_NAME)
    }
    ...
    public async readGeneralRoleByName(name: string | undefined, queryRunner: QueryRunner) {
        ...
        if (!generalRole) throw new InternalDtamindError(StatusCodes.NOT_FOUND, RoleErrorMessage.ROLE_NOT_FOUND)
        return generalRole
    }
    ...
    public async readRoleByGeneral(queryRunner: QueryRunner) {
        ...
        if (generalRoles.length <= 0) throw new InternalDtamindError(StatusCodes.NOT_FOUND, RoleErrorMessage.ROLE_NOT_FOUND)
        return generalRoles
    }
    ...
    public async createRole(data: Partial<Role>) {
        ...
        if (!data.permissions) throw new InternalDtamindError(StatusCodes.BAD_REQUEST, RoleErrorMessage.INVALID_ROLE_PERMISSIONS)
    ...
    public async updateRole(newRole: Partial<Role>) {
        ...
        if (!oldRole) throw new InternalDtamindError(StatusCodes.NOT_FOUND, RoleErrorMessage.ROLE_NOT_FOUND)
