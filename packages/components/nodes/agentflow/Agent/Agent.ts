    ...
    async run(nodeData: INodeData, input: string | Record<string, any>, options: ICommonObject): Promise<any> {
        ...
        try {
            ...
            for (const tool of tools) {
                ...
                const newNodeData = {
                    ...nodeData,
                    credential: toolConfig['DTAMIND_CREDENTIAL_ID'],
                    inputs: {
                        ...nodeData.inputs,
                        ...toolConfig
                    }
            ...
            if (knowledgeBasesForVSEmbeddings && knowledgeBasesForVSEmbeddings.length > 0) {
                for (const knowledgeBase of knowledgeBasesForVSEmbeddings) {
                    ...
                    const newEmbeddingNodeData = {
                        ...nodeData,
                        credential: selectedEmbeddingModelConfig['DTAMIND_CREDENTIAL_ID'],
                        inputs: {
                            ...nodeData.inputs,
                    ...
                    const newVSNodeData = {
                        ...nodeData,
                        credential: selectedVectorStoreConfig['DTAMIND_CREDENTIAL_ID'],
                        inputs: {
                            ...nodeData.inputs,
            ...
            const newNodeData = {
                ...nodeData,
                credential: modelConfig['DTAMIND_CREDENTIAL_ID'],
                inputs: {
                    ...nodeData.inputs,
                    ...modelConfig
                }
