...
import { ChatAnthropic } from '../../chatmodels/ChatAnthropic/DtamindChatAnthropic'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.dtamindai.com/memory#ui-and-embedded-chat">more</a>',
                default: '',
                optional: true,
...
class ConversationSummaryBufferMemoryExtended extends DtamindSummaryBufferMemory implements MemoryMethods {
    appDataSource: DataSource
    databaseEntities: IDatabaseEntity
    chatflowid: string
    orgId: string
