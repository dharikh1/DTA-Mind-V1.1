...
import { IVisionChatModal, DtamindMemory, ICommonObject, IMessage, INode, INodeData, INodeParams } from '../../../src/Interface'
...
class ReActAgentChat_Agents implements INode {
    ...
    async run(nodeData: INodeData, input: string, options: ICommonObject): Promise<string | object> {
        const memory = nodeData.inputs?.memory as DtamindMemory
