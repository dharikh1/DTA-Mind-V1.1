    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                name: 'filter',
                description:
                    'Filter to apply to Vectara metadata. Refer to the <a target="_blank" href="https://docs.dtamindai.com/vector-stores/vectara">documentation</a> on how to use Vectara filters with Dtamind.',
                type: 'string',
