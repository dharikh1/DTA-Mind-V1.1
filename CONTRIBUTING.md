...
Star and share the [Github Repo](https://github.com/DtamindAI/Dtamind).

## 🙋 Q&A

Search up for any questions in [Q&A section](https://github.com/DtamindAI/Dtamind/discussions/categories/q-a), if you can't find one, don't hesitate to create one. It might helps others that have similar question.

## 🙌 Share Chatflow

Yes! Sharing how you use Dtamind is a way of contribution. Export your chatflow as JSON, attach a screenshot and share it in [Show and Tell section](https://github.com/DtamindAI/Dtamind/discussions/categories/show-and-tell).

## 💡 Ideas

Ideas are welcome such as new feature, apps integration, and blockchain networks. Submit in [Ideas section](https://github.com/DtamindAI/Dtamind/discussions/categories/ideas).

## 🐞 Report Bugs

Found an issue? [Report it](https://github.com/DtamindAI/Dtamind/issues/new/choose).
...
1. Fork the official [Dtamind Github Repository](https://github.com/DtamindAI/Dtamind).
...
11. Commit code and submit Pull Request from forked branch pointing to [Dtamind master](https://github.com/DtamindAI/Dtamind/tree/master).

## 🌱 Env Variables

Dtamind support different environment variables to configure your instance. You can specify the following variables in the `.env` file inside `packages/server` folder. Read [more](https://docs.dtamindai.com/environment-variables)
...
| DATABASE_TYPE                      | Type of database to store the dtamind data                                       | Enum String: `sqlite`, `mysql`, `postgres`       | `sqlite`                            |
| DATABASE_PATH                      | Location where database is saved (When DATABASE_TYPE is sqlite)                  | String                                           | `your-home-dir/.dtamind`            |
...
[Dtamind Docs](https://github.com/DtamindAI/DtamindDocs)

## 🏷️ Pull Request process

A member of the DtamindAI team will automatically be notified/assigned when you open a pull request. You can also reach out to us on [Discord](https://discord.gg/jbaHfsRVBW).

## 📜 Code of Conduct

This project and everyone participating in it are governed by the Code of Conduct which can be found in the [file](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to hello@dtamindai.com.
