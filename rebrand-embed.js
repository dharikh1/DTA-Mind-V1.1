...
console.log('🚀 Starting flowise-embed rebranding process...');

// Configuration
const sourcePackage = 'flowise-embed';
const targetPackage = 'dtamind-embed-react';
...
async function rebrandPackage() {
    try {
        ...
        const tarball = files.find(file => file.startsWith('flowise-embed-') && file.endsWith('.tgz'));
        ...
        packageJson.description = 'React embed component for Dtamind chatbots';
        packageJson.keywords = ['dtamind', 'ai', 'embed', 'react', 'chatbot'];
        ...
        if (fs.existsSync(readmePath)) {
            ...
            readme = readme.replace(/flowise-embed/g, 'dtamind-embed-react');
            readme = readme.replace(/Flowise Embed/g, 'Dtamind Embed React');
            readme = readme.replace(/Apps integration for Flowise/g, 'React embed component for Dtamind');
        ...
        const newDir = `dtamind-embed-react-${targetVersion}`;
    ...
    for (const file of files) {
        ...
        if (file.isDirectory()) {
            ...
            try {
                ...
                content = content.replace(/from ['"]flowise-embed['"]/g, "from 'dtamind-embed-react'");
                content = content.replace(/import ['"]flowise-embed['"]/g, "import 'dtamind-embed-react'");
                content = content.replace(/require\(['"]flowise-embed['"]\)/g, "require('dtamind-embed-react')");
                content = content.replace(/flowise-embed/g, 'dtamind-embed-react');
