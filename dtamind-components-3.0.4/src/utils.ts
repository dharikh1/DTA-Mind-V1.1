...
export const dtamind_CHATID = 'dtamind_chatId'
...
/*
 * List of dependencies allowed to be import in @dtamindai/nodevm
 */
...
const jsonEscapeCharacters = [
    { escape: '"', value: 'dtamind_DOUBLE_QUOTE' },
    { escape: '\n', value: 'dtamind_NEWLINE' },
    { escape: '\b', value: 'dtamind_BACKSPACE' },
    { escape: '\f', value: 'dtamind_FORM_FEED' },
    { escape: '\r', value: 'dtamind_CARRIAGE_RETURN' },
    { escape: '\t', value: 'dtamind_TAB' },
    { escape: '\\', value: 'dtamind_BACKSLASH' }
]
