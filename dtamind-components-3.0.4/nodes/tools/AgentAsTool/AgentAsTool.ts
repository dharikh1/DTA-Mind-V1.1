...
import { z } from 'zod'
import { NodeVM } from '@dtamindai/nodevm'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'Base URL to Dtamind. By default, it is the URL of the incoming request. Useful when you need to execute the Agentflow through an alternative route.',
