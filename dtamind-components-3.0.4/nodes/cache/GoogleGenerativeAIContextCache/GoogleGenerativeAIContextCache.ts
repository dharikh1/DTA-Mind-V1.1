...
import DtamindGoogleAICacheManager from './DtamindGoogleAICacheManager'
...
class GoogleGenerativeAIContextCache implements INode {
    ...
    constructor() {
        ...
        this.category = 'Cache'
        this.baseClasses = [this.type, ...getBaseClasses(DtamindGoogleAICacheManager)]
        this.inputs = [
            {
                label: 'TTL',
                name: 'ttl',
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        const manager = new DtamindGoogleAICacheManager(apiKey)
